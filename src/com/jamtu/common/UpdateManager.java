...
public class UpdateManager {
	...
	public Update getUpdateInfo() throws AppException {
		try {
			Request request = new Request.Builder().url(PrefUtil.UPDATE_URL).build();
			...
			file.delete();
			return (Update) Update.fromJson(response.body().string(), Update.class);
		} catch (IOException e) {
	...
	private Runnable mdownApkRunnable = new Runnable() {
		...
		public void run() {
			try {
				String apkName = "IJoke_" + mUpdate.getVersion() + ".apk";
				String tmpApk = "IJoke_" + mUpdate.getVersion() + ".tmp";
				// 判断是否挂载了SD卡
				String storageState = Environment.getExternalStorageState();
				if (storageState.equals(Environment.MEDIA_MOUNTED)) {
					savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/IJoke/Update/";
