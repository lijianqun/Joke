...
package com.jamtu.db.library.db.table;
...
import com.jamtu.db.library.db.annotation.Check;
import com.jamtu.db.library.db.annotation.Column;
import com.jamtu.db.library.db.annotation.Finder;
import com.jamtu.db.library.db.annotation.Foreign;
import com.jamtu.db.library.db.annotation.Id;
import com.jamtu.db.library.db.annotation.NotNull;
import com.jamtu.db.library.db.annotation.Transient;
import com.jamtu.db.library.db.annotation.Unique;
import com.jamtu.db.library.db.converter.ColumnConverter;
import com.jamtu.db.library.db.converter.ColumnConverterFactory;
import com.jamtu.db.library.db.sqlite.FinderLazyLoader;
import com.jamtu.db.library.db.sqlite.ForeignLazyLoader;
import com.jamtu.db.library.util.LogUtils;
...
public class ColumnUtils {
	...
	public static Class<?> getForeignEntityType(com.jamtu.db.library.db.table.Foreign foreignColumn) {
	...
	@SuppressWarnings("unchecked")
	public static Class<?> getFinderTargetEntityType(com.jamtu.db.library.db.table.Finder finderColumn) {
